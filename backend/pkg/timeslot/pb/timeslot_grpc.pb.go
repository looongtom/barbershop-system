...
func (c *timeslotServiceClient) FindExistTimeslot(ctx context.Context, in *FindTimeslotRequest, opts ...grpc.CallOption) (*TimeslotList, error) {
	...
	err := c.cc.Invoke(ctx, TimeslotService_FindExistTimeslot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterTimeslotServiceServer(s grpc.ServiceRegistrar, srv TimeslotServiceServer) {
	// If the following call pancis, it indicates UnimplementedTimeslotServiceServer was
